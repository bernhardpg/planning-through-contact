...
def visualize_planar_pushing_trajectory_drake(
    traj: PlanarTraj, slider_geometry: CollisionGeometry
):
    breakpoint()
...
def plan_planar_pushing(
    ...
    traj = PlanarTraj(R_traj, com_traj, contact_pos_traj, force_traj)
    ...
    visualize_planar_pushing_trajectory_drake(traj, slider.geometry)
