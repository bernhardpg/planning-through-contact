...
# from diffusion_policy.dataset.base_dataset import BaseImasgeDataset
...
class DiffusionPolicyController(LeafSystem):
    def __init__(
        ...
        # get parameters
        # TODO: get parameters from checkpoint
        # self._obs_horizon = self._cfg.policy.n_obs_steps
        # self._action_steps = self._cfg.n_action_steps
        self._obs_horizon = 2
        self._action_steps = 8
        self._image_width = 96
        self._image_height = 96
