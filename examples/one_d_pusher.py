...
def plan_for_one_finger_two_boxes():
    # Bezier curve params
    dim = 2
    order = 2
    ...
    pair_box_1_box_2 = CollisionPair(
        box_1,
        "right_edge",
        box_2,
        "left_edge",
    ...
    planner.add_source(source_constraints)
    planner.add_target(target_constraints)
    print("Finished adding source and target")

    planner.save_graph_diagram("graph_without_revisits.svg")
    print("Saved graph as diagram")
    planner.allow_revisits_to_vertices(0)  # TODO not optimal to call this here
