# From https://github.com/RobotLocomotion/drake/blob/master/examples/hardware_sim/hardware_sim.py
# Modifications:
# add JointStiffnessDriver to the list of possible drivers
# Configure Parser
...
def run(*, scenario, graphviz=None):
    ...
    parser = Parser(sim_plant, scene_graph)
