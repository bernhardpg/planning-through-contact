...
def run_data_generation_script(config_name, plans_dir):
    ...
    command = (
        ...
        f"data_collection_config.rendered_plans_dir=trajectories_rendered/single_box200"
    )
...
start_index = 0
end_index = 4  # Adjust this value as needed
...
if __name__ == "__main__":
    ...
    for i in tqdm(
        ...
        plans_dir = f"trajectories/single_box200/run_{i}"
        print(plans_dir)
